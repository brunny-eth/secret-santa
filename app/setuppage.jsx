    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <p style={{
          ...
          Welcome to the Simple Secret Santa.<br /><br />
          Add your participants to the game below.<br /><br />
          Once complete, each person will be able to login with their date of birth to discover their match and get gift suggestions generated by AI.
        </p>
          ...
          >
            ...
            {expandedCards.includes(participant.id) && (
              <div style={{ padding: '0 20px 20px 20px' }}>
                ...
                <div style={{ marginBottom: '15px' }}>
                  <label style={{ display: 'block', marginBottom: '5px' }}>
                    Interests and Hobbies (use a comma to separate)
                  </label>
                  <input
                    type="text"
